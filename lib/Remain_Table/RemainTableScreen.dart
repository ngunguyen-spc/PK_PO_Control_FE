...
//         div: div, date: date, cusID: 'All', shipBy: 'All',
//       );
//       final List<RemainTableDetailIDModel> detailsID = await provider.fetchDetailID(
//         div: div, date: date, cusID: 'All', shipBy: 'All',
//       );
//       overlay.remove();
//       if (!mounted) return;
    ...
    return Scaffold(
      body: Consumer<RemainTableProvider>(
        builder: (context, provider, child) {
          ...
          // ✅ date string để truyền xuống widget (dùng cho popup)
          final dateStr = DateFormat('yyyy-MM-dd').format(adjusted);
                    ...
                    _SummaryRow(
                      items: [
                        ...
                        _SummaryItem(label: 'Remain PO',  value: fmt.format(totalRemPO),
                            highlight: totalRemPO > 0),
                        _SummaryItem(label: 'Remain Qty', value: fmt.format(totalRemQty),
                            highlight: totalRemQty > 0),
                      ],
                    ),
                  ],
                    ...
                    child: Card(
                      ...
                      child: Padding(
                        ...
                        child: RemainTableWidget(
                          data:  provider.data,
                          month: month,
                          div:   widget.div,   // ✅ truyền xuống
                          date:  dateStr,      // ✅ truyền xuống
                        ),
                      ),
                    ),
                  ),
